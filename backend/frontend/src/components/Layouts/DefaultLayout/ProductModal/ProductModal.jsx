            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="row mb-3">
                <div className="col-md-4">
                  <label htmlFor="productPrice" className="form-label">Giá bán</label>
                ...
                <div className="col-md-4">
                  <label htmlFor="productStatus" className="form-label">Trạng thái</label>
              ...
              <div className="mb-3">
                <label htmlFor="productImages" className="form-label">Hình ảnh sản phẩm</label>
