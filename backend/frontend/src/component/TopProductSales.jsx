...
const products = [
  { id: 1, img1: product1, img2: product2, title: 'Best Seller Sofa', categories: ['sofa'], price: 299, oldPrice: 350, tags: ['sale'] },
  { id: 2, img1: product2, img2: product4, title: 'Trending Armchair', categories: ['chair'], price: 159, oldPrice: 199, tags: ['hot'] },
  { id: 3, img1: product4, img2: product1, title: 'Top Desk Design', categories: ['table'], price: 189, oldPrice: 210, tags: ['top'] },
  { id: 4, img1: product1, img2: product2, title: 'Popular Lamp Decor', categories: ['decor'], price: 49, oldPrice: 69, tags: [] },
  { id: 5, img1: product2, img2: product1, title: 'Comfort Chair', categories: ['furniture'], price: 119, oldPrice: 140, tags: ['hot'] },
  { id: 6, img1: product4, img2: product2, title: 'Stylish Bookshelf', categories: ['bookshelf'], price: 219, oldPrice: 249, tags: ['top'] }
];
