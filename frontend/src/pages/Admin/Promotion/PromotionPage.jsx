...
const PromotionPage = () => {
  ...
  const deletePromotion = async (promotionId) => {
    if (
      window.confirm(`Bạn có chắc chắn muốn xóa mã khuyến mãi #${promotionId}?`)
    ) {
      try {
    ...
    <div className="noi-dung-chinh">
      <div className="container-fluid">
        <div className="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 className="h3 mb-0 text-gray-800">Quản lý mã khuyến mãi</h1>
          ...
          <div className="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <Dropdown>
              <Dropdown.Toggle variant="dark" id="dropdown-basic">
                <FontAwesomeIcon icon={faFilter} className="me-1" /> Lọc
              </Dropdown.Toggle>
              <Dropdown.Menu>
                ...
                <Dropdown.Item onClick={() => setFilterStatus("expired")}>
                  Hết hạn
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
